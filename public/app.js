...
async function renderRoute() {
  ...
  content.innerHTML = route === 'executive' ? executiveTemplate() : route === 'stories' ? storyRepositoryTemplate() : route === 'decisions' ? decisionCenterTemplate() : route === 'audiences' ? audienceIntelligenceTemplate() : route === 'learning' ? learningWorkspaceTemplate() : comingSoonTemplate(route);
  content.focus();
